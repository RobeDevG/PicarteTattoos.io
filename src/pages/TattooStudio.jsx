import Elestudio from '../assets/Elestudio.webp'
  ...
  return (
    <section>
      ...
      <div className="shadow-bg bg-bg-Study bg-cover bg-no-repeat bg-center flex lg:flex-row flex-col-reverse lg:pt-16 lg:pb-32 items-center justify-center lg:justify-normal lg:items-start">
        <img className="lg:ml-16 lg:mr-8" src={Elestudio} alt="foto del estudio" loading="lazy"/>
        <div className="flex flex-col text-center lg:text-left text-white">
          ...
          <p className=" text-3xl  lg:max-w-3xl max-w-96 mr-4 ml-4 mb-6 lg:m-0 font-font-Kelly ">{t("TattooStudio.text_1")}</p>
        </div>
      </div>
    </section>
  )
