      ...
      <section className='bg-[#151515] flex xl:flex-row flex-col justify-center items-center xl:items-start text-center text-white pb-6'>
        ...
        <div className='flex flex-col xl:items-stretch items-center justify-center xl:justify-stretch lg:w-2/4 text-white text-center sm:text-start'>
          ...
          <form className='flex flex-col xl:items-stretch items-center justify-center xl:justify-stretch text-white' action="">
            ...
            <input type="text" id='name' className='bg-[#262626] box-shadowimp w-[300px] sm:w-[600px] h-20 mt-3 text-4xl' />

            <label htmlFor="email" className='font-font-slider text-2xl mt-14'>{t("Contact.label_2")}</label>
            <input type="email" id='email' className='bg-[#262626] box-shadowimp w-[300px] sm:w-[600px] h-20 mt-3 text-4xl' />

            <label htmlFor="subject" className='font-font-slider text-2xl mt-14'>{t("Contact.label_3")}</label>
            <input type="text" id='subject' className='bg-[#262626] box-shadowimp w-[300px] sm:w-[600px] h-20 mt-3 text-4xl' />

            <label htmlFor="message" className='font-font-slider text-2xl mt-14'>{t("Contact.label_4")}</label>
            <textarea type="text" id='message' className='bg-[#262626] box-shadowimp w-[300px] sm:w-[600px] h-64 mt-3 text-4xl resize-none' />
