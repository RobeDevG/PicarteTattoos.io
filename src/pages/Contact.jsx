...
function Contact() {
  ...
  return (
    <section className='bg-bg-Primary bg-center bg-cover bg-no-repeat'>
      ...
      <section className='bg-[#151515] flex text-white pb-6'>
        ...
        <div className='flex flex-col w-2/4 text-white'>
          <h2 className='font-custom-font text-5xl mt-3'>{t("Contact.title_form")}</h2>
          <p className='font-font-slider text-2xl mt-10'>{t("Contact.des_form")}</p>
          <form className='flex flex-col text-white' action="">
            ...
            <input type="text" className='bg-[#262626] box-shadowimp numbs_3 h-64 mt-3 text-4xl' />
      ...
      <div>
        <div className='flex flex-col items-center justify-center text-white'>
          ...
          <p className='font-font-slider mt-14 flex items-center mb-14'><img src={Address} alt="" />Matanzas / Matanzas</p>
          <AddressMap />
        </div>
      </div>
    </section>
