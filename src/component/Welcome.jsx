...
function Welcome() {
  ...
  return (
    <section className="bg-bg-Primary bg-center bg-cover bg-no-repeat flex flex-col justify-center items-center font-custom-font gap-4 text-center">
      ...
      <p className="text-2xl text-white text_shadow_B max-w-6xl">{t("welcome.text_3")}</p>
      <p className="text-2xl text-white text_shadow_B max-w-6xl">{t("welcome.text_4")}</p>
      <p className="text-2xl text-white text_shadow_B max-w-6xl">{t("welcome.text_5")}</p>
      </div>
