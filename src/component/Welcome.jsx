  ...
  return (
    <section className="bg-bg-Primary bg-center bg-cover bg-no-repeat flex flex-col justify-center items-center font-custom-font gap-4 text-center">
      <div className="flex flex-col justify-center items-center gap-4 text-center mt-8 mb-36">
        ...
        <p className="sm:text-2xl text-base text-white text_shadow_B max-w-6xl font-font-Kelly">{t("welcome.text_3")}</p>
        <p className="sm:text-2xl text-base text-white text_shadow_B max-w-6xl font-font-Kelly">{t("welcome.text_4")}</p>
        <p className="sm:text-2xl text-base text-white text_shadow_B max-w-6xl font-font-Kelly">{t("welcome.text_5")}</p>
      </div>
